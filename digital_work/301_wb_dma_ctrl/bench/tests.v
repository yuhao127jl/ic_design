...
begin
        ...
        {15'h0002, 3'b000, 1'b0, 6'd1, 4'b0011, 2'b00, 1'b1});
...
begin
        ...
        d0 = {28'h0064_089, 1'b1, mode[1:0], 1'b0};
        if( d1 !== d0 )
           begin
...
$display("a: %0d", a);
        ...
        m0.wb_wr1(`REG_BASE + `CH0_CSR,4'hf,
                {17'h00000, pri[1:0], 6'd0, 4'b0011, mode[1:0], 1'b0});
 
        m0.wb_wr1(`REG_BASE + `CH1_CSR,4'hf,
                {17'h00000, pri[3:2], 6'd0, 4'b0011, mode[1:0], 1'b0});
 
        m0.wb_wr1(`REG_BASE + `CH2_CSR,4'hf,
                {17'h00000, pri[5:4], 6'd0, 4'b0011, mode[1:0], 1'b0});
 
        m0.wb_wr1(`REG_BASE + `CH3_CSR,4'hf,
                {17'h00000, pri[7:6], 6'd0, 4'b0011, mode[1:0], 1'b0});
        ...
        m0.wb_wr1(`REG_BASE + `CH0_CSR,4'hf,
                {12'd0, 3'b010, 1'b0, 1'b0, pri[1:0], 6'h0, 4'b0011, mode[1:0], 1'b1});
 
                //{15'h0002, 3'b000, 1'b0, 6'h1, 4'b0011, 2'b00, 1'b1});
 
        m0.wb_wr1(`REG_BASE + `CH1_CSR,4'hf,
                {12'd0, 3'b010, 1'b0, 1'b0, pri[3:2], 6'h0, 4'b0011, mode[1:0], 1'b1});
 
        m0.wb_wr1(`REG_BASE + `CH2_CSR,4'hf,
                {12'd0, 3'b010, 1'b0, 1'b0, pri[5:4], 6'h0, 4'b0011, mode[1:0], 1'b1});
 
 
 
        m0.wb_wr1(`REG_BASE + `CH3_CSR,4'hf,
                {12'd0, 3'd2, 1'b0, 1'b0, pri[7:6], 6'd0, 4'b0011, mode[1:0], 1'b1});
...
for(rep=0;rep<4;rep=rep+1)
   begin
        ...
        fork
           ...
           begin
                repeat(1)       @(posedge clk);
                while(!wb_dma_top.dma_done_all) @(posedge clk);
...
del = 0;
        ...
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH0_CSR,4'hf, 32'h0);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH1_CSR,4'hf, 32'h0);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH2_CSR,4'hf, 32'h0);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH3_CSR,4'hf, 32'h0);
 
        test_bench_top.m0.wb_rd1(`REG_BASE + `INT_SRCA, 4'hf, int_src);
...
begin
        ...
        test_bench_top.m0.wb_wr1(`REG_BASE + `INT_MASKA,4'hf,32'hffff_ffff);
 
        test_bench_top.m0.wb_wr1(`REG_BASE + `PTR0, 4'hf, 32'h0000_0000);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH0_TXSZ,4'hf, {chunk_sz, 16'h0fff});
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH0_ADR0,4'hf,32'h0000_ffff);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH0_ADR1,4'hf,32'h0000_ffff);
 
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH0_CSR,4'hf,
                        //{25'h0000001, 4'b0111, 2'b00, 1'b1});
                        {12'h000, 3'b010, 1'b0, 9'h001, 4'b0111, 2'b00, 1'b1});
 
        test_bench_top.m0.wb_wr1(`REG_BASE + `PTR1, 4'hf, 32'h0000_0020);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH1_TXSZ,4'hf, {chunk_sz, 16'h0fff});
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH1_ADR0,4'hf,32'h0000_ffff);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH1_ADR1,4'hf,32'h0000_ffff);
 
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH1_CSR,4'hf,
                        //{25'h0000001, 4'b0111, 2'b00, 1'b1});
                        {12'h000, 3'b010, 1'b0, 9'h001, 4'b0111, 2'b00, 1'b1});
 
        test_bench_top.m0.wb_wr1(`REG_BASE + `PTR2, 4'hf, 32'h0000_0040);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH2_TXSZ,4'hf, {chunk_sz, 16'h0fff});
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH2_ADR0,4'hf,32'h0000_ffff);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH2_ADR1,4'hf,32'h0000_ffff);
 
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH2_CSR,4'hf,
                        //{25'h0000001, 4'b0111, 2'b00, 1'b1});
                        {12'h000, 3'b010, 1'b0, 9'h001, 4'b0111, 2'b00, 1'b1});
 
        test_bench_top.m0.wb_wr1(`REG_BASE + `PTR3, 4'hf, 32'h0000_0060);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH3_TXSZ,4'hf, {chunk_sz, 16'h0fff});
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH3_ADR0,4'hf,32'h0000_ffff);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH3_ADR1,4'hf,32'h0000_ffff);
 
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH3_CSR,4'hf,
                        //{25'h0000001, 4'b0111, 2'b00, 1'b1});
                        {12'h000, 3'b010, 1'b0, 9'h001, 4'b0111, 2'b00, 1'b1});
        ...
        fork
           ...
           begin
                ...
                if(int_src[0])
                   begin
                        test_bench_top.m0.wb_rd1(`REG_BASE + `CH0_CSR, 4'hf, d0);
                        i=i+1;
                        for(n=0;n<tot_sz*2;n=n+1)
                           begin
                                if(mode[1])     d0=s1.mem[(s0.mem[1]>>2) + n ];
                ...
                if(int_src[1])
                   begin
                        test_bench_top.m0.wb_rd1(`REG_BASE + `CH1_CSR, 4'hf, d0);
                        i=i+1;
                        for(n=0;n<tot_sz*2;n=n+1)
                           begin
                                if(mode[1])     d0=s1.mem[(s0.mem[9]>>2) + n ];
                ...
                if(int_src[2])
                   begin
                        test_bench_top.m0.wb_rd1(`REG_BASE + `CH2_CSR, 4'hf, d0);
                        i=i+1;
                        for(n=0;n<tot_sz*2;n=n+1)
                           begin
                ...
                if(int_src[3])
                   begin
                        test_bench_top.m0.wb_rd1(`REG_BASE + `CH3_CSR, 4'hf, d0);
                        i=i+1;
                        for(n=0;n<tot_sz*2;n=n+1)
                           begin
...
begin
        ...
        test_bench_top.m0.wb_wr1(`REG_BASE + `PTR1, 4'hf, 32'h0000_0040);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH1_TXSZ,4'hf, {chunk_sz, 16'h0fff});
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH1_ADR0,4'hf,32'h0000_ffff);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH1_ADR1,4'hf,32'h0000_ffff);
        ...
        test_bench_top.m0.wb_wr1(`REG_BASE + `PTR2, 4'hf, 32'h0000_0080);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH2_TXSZ,4'hf, {chunk_sz, 16'h0fff});
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH2_ADR0,4'hf,32'h0000_ffff);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH2_ADR1,4'hf,32'h0000_ffff);
        ...
        test_bench_top.m0.wb_wr1(`REG_BASE + `PTR3, 4'hf, 32'h0000_00c0);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH3_TXSZ,4'hf, {chunk_sz, 16'h0fff});
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH3_ADR0,4'hf,32'h0000_ffff);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH3_ADR1,4'hf,32'h0000_ffff);
...
for(chunk_sz=0;chunk_sz<chunk_sz_max;chunk_sz=chunk_sz+1)
   begin
        ...
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH0_TXSZ,4'hf, {chunk_sz, tot_sz});
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH0_ADR0,4'hf,32'h0000_0000);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH0_ADR1,4'hf,32'h0000_4000);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH0_CSR,4'hf,
        ...
        test_bench_top.m0.wb_rd1(`REG_BASE + `INT_SRCA, 4'hf, d1);
        d0 = 32'h0000_0001;
        if( d1 !== d0 )
           begin
        ...
        test_bench_top.m0.wb_rd1(`REG_BASE + `CH0_CSR, 4'hf, d1);
        d0 = {28'h0064_081, 1'b1, mode[1:0], 1'b0};
        if( d1 !== d0 )
           begin
                $display("ERROR: CH0_CSR Mismatch: Expected: %x, Got: %x (%0t)",
                        d0, d1, $time);
...
for(chunk_sz=0;chunk_sz<chunk_sz_max;chunk_sz=chunk_sz+1)
   ...
   begin
        ...
        s0.fill_mem(1);
        s1.fill_mem(1);
        test_bench_top.m0.wb_wr1(`REG_BASE + `INT_MASKB,4'hf,32'hffff_ffff);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH0_TXSZ,4'hf, {chunk_sz, tot_sz});
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH0_ADR0,4'hf,32'h0000_0000);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH0_ADR1,4'hf,32'h0000_4000);
        test_bench_top.m0.wb_wr1(`REG_BASE + `CH0_CSR,4'hf,
        ...
        test_bench_top.m0.wb_rd1(`REG_BASE + `INT_SRCB, 4'hf, d1);
        d0 = 32'h0000_0001;
        if( d1 !== d0 )
           begin
                $display("ERROR: INT_SRC Mismatch: Expected: %x, Got: %x (%0t)",
...
for(d=0;d<16;d=d+1)
 begin
   ...
   for(n=0;n<512;n=n+4)
     begin
        test_bench_top.m0.wb_rd4(n<<2,4'hf,d,d0,d1,d2,d3);
...
$display("\nINFO: PT10 RD1");
   for(n=0;n<512;n=n+1)
     begin
        test_bench_top.m0.wb_rd1(n<<2,4'hf,d0);
 ...
 begin
   ...
   for(n=0;n<512;n=n+4)
     begin
        ...
        d2 = $random;
        d3 = $random;
        test_bench_top.m0.wb_wr4(n<<2,4'hf,d,d0,d1,d2,d3);
        @(posedge clk);
...
$display("\nINFO: PT10 WR1");
   for(n=0;n<512;n=n+1)
     begin
        d0 = $random;
        test_bench_top.m0.wb_wr1(n<<2,4'hf,d0);
        @(posedge clk);
