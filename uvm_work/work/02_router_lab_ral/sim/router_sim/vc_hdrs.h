...
#define SV_STRING char*
 ...
 extern void* svapfGetAttempt(unsigned int assertHandle);

 extern void svapfReportResult(unsigned int assertHandle, void* ptrAttempt, int result);

 extern int svapfGetAssertEnabled(unsigned int assertHandle);
